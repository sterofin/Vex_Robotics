...
static void speed(int speedleft, int speedright)
{
	motor[Lbackwheel] = speedleft;
	motor[Lfrontwheel] = speedleft;
	motor[Rbackwheel] = speedright;
	motor[Rfrontwheel] = speedright;
}

static void Outspeed(int speed)
{
	motor[Routtake] = speed;
	motor[Louttake] = speed;
}
static void Inspeed(int speed)
{
	motor[Rintake] = speed;
	motor{LIntake] = speed;
}
